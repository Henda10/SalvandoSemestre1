        ...
        <table class="min-w-full divide-y divide-gray-200 my-3">
            <thead class="bg-gray-100 text-center border divide-y">
                <tr>
                    ...
                    <th class="border px-2 py-2">Numero de Chasis</th>
                    <th class="border px-2 py-2">Matricula</th>
            ...
            <tbody class="bg-white divide-y min-w-full divide-gray-200">
                ...
                <tr class="text-center">
                    <td class="border px-2 py-2 whitespace-nowrap">{{$mot->id}}</td>
                    <td class="border px-2 py-2 whitespace-nowrap">{{$mot->Marca}}</td>
                    <td class="border px-2 py-2 whitespace-nowrap">{{$mot->Modelo}}</td>
                    <td class="border px-2 py-2 whitespace-nowrap">{{$mot->NumeroChasis}}</td>
                    <td class="border px-2 py-2 whitespace-nowrap">{{$mot->Matricula}}</td>
                    <td class="border px-2 py-2 whitespace-nowrap">

                        <a href="{{route('Motos.edit',$mot->id)}}">
                            <button
                        ...
                        <form action="{{route('Motos.destroy',$mot)}}"method="POST">
                            @csrf
                            @method('delete')
                            <button
