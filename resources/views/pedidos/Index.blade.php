            ...
            <table class="min-w-full divide-y divide-gray-200 my-3">
                <thead class="bg-gray-100 text-center border divide-y">
                    <tr>
                        ...
                        <th class="border px-2 py-2">Descripcion</th>
                        <th class="border px-2 py-2">Precio Delivery</th>
                ...
                <tbody class="bg-white divide-y min-w-full divide-gray-200">
                    ...
                    <tr class="text-center">
                        <td class="border px-2 py-2 whitespace-nowrap">{{$pedido->id}}</td>
                        <td class="border px-2 py-2 whitespace-nowrap">{{$pedido->Descripcion}}</td>
                        <td class="border px-2 py-2 whitespace-nowrap">{{$pedido->PrecioDelivery}}</td>
                        <td class="border px-2 py-2 whitespace-nowrap">{{$pedido->Estado}}</td>
                        {{-- Acciones --}}
                        <td class="border px-2 py-2 flex justify-around items-center">
                            ...
                            {{-- eliminar --}}
                            <form action="{{route('pedidos.destroy',$pedidos)}}"method="POST">
                                @csrf
                                @method('DELETE')
                                <button
