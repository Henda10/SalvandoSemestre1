    ...
    <div class="form-container__center">
      ...
      <form action="/register" method="POST" class="form-content resgister-form">
        ...
        <label class="input-label">
          <input class="input register-input" type="text" name="name" placeholder=" " autocomplete="off">
          <span class="placeholder-span">Ingresar usuario</span>
        </label>
        <label class="input-label">
          <input class="input register-input" type="email" name="email" placeholder=" " autocomplete="off">
          <span class="placeholder-span">Ingresar Correo Electronico</span>
        </label>
        <label class="input-label">
